...
public class MainProyecto {
	...
	public static void main(String[] args) throws IOException {
		...
		String email;
		String contrasena;
		int codpos=0,cod_restaurante=0;
						...
						do{
							...
							case 7:
								...
								case 0:
									...
									break;
								case 1:
									System.out.println("Oferta borrada con éxito");
									break;
								case -1:
									System.out.println("Ha ocurrido un error, vuelva ha intentarlo más tarde.");
									break;
							...
							case 8:
								...
								case 0:
									...
									break;
								case 1:
									System.out.println("Modificacion de matricula realizada con éxito");
									break;
								case -1:
									System.out.println("Ha ocurrido un error, vuelva ha intentarlo más tarde.");
									break;
						...
						if(usuarior.getTipo().equals("resta")){
							...
							case 2:
								...
								case 0:
									...
									break;
								case 1:
									System.out.println("borrado el plato con éxito");
									break;
								case -1:
									System.out.println("Ha ocurrido un error, vuelva ha intentarlo más tarde.");
									break;
